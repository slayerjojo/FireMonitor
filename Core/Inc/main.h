...
#define RELAY_FRAME_Pin GPIO_PIN_8
#define RELAY_FRAME_GPIO_Port GPIOD
#define RELAY_SAFE_Pin GPIO_PIN_9
...
#define RELAY_FRAME_FB_Pin GPIO_PIN_6
#define RELAY_FRAME_FB_GPIO_Port GPIOC
#define RELAY_SAFE_FB_Pin GPIO_PIN_7
#define RELAY_SAFE_FB_GPIO_Port GPIOC
#define DL1_Pin GPIO_PIN_8
#define DL1_GPIO_Port GPIOC
#define DL2_Pin GPIO_PIN_9
#define DL2_GPIO_Port GPIOC
...
#define LED_SEG1_Pin GPIO_PIN_10
#define LED_SEG1_GPIO_Port GPIOC
#define LED_SEG2_Pin GPIO_PIN_11
#define LED_SEG2_GPIO_Port GPIOC
#define LED_SEG3_Pin GPIO_PIN_12
#define LED_SEG3_GPIO_Port GPIOC
#define LED_SEGA_Pin GPIO_PIN_0
#define LED_SEGA_GPIO_Port GPIOD
#define LED_SEGB_Pin GPIO_PIN_1
#define LED_SEGB_GPIO_Port GPIOD
#define LED_SEGC_Pin GPIO_PIN_2
#define LED_SEGC_GPIO_Port GPIOD
#define LED_SEGD_Pin GPIO_PIN_3
#define LED_SEGD_GPIO_Port GPIOD
#define LED_SEGE_Pin GPIO_PIN_4
#define LED_SEGE_GPIO_Port GPIOD
#define LED_SEGF_Pin GPIO_PIN_5
#define LED_SEGF_GPIO_Port GPIOD
#define LED_SEGG_Pin GPIO_PIN_6
#define LED_SEGG_GPIO_Port GPIOD
#define LED_SEGDP_Pin GPIO_PIN_7
